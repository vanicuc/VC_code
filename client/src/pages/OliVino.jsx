    ...
    <>
      ...
      <section className="section_3">
        <div className="text_section" id="Define">
          ...
          <div className="Define_img">
            <img src="./images/laidy 1.png" alt="pld woman" />
            <img src="./images/laidy 2.png" alt="pld woman" />
            <img src="./images/laidy 3.png" alt="pld woman" />
            <img src="./images/laidy 4.png" alt="pld woman" />
          </div>
        </div>
      </section>
      ...
      <section className="section_6">
        <div className="text_section" id="Ideate">
          ...
          <div className="img_arq_section">
            <img
              src="./images/Olivino  arquitectura.png"
      ...
      <section className="section_4">
        <div className="text_section" id="Prototype">
          ...
          <div>
            <img src="./images/Moodboard_olivino.png" alt="Moodboard_olivino" />
          </div>
        </div>
      </section>
